...
<head>
    ...
    <title>УПРАВЛЕНИЕ САДОВЫМ ТОВАРИЩЕСТВОМ</title>
...
?>
 ...
 <h1 class="h3 mb-0 text-gray-800"><?php echo $result['FirstName'];?> Профиль | Изменить Профиль</h1>
                    </div>
...
<form method="post">
 ...
 <a href="change-emailid.php?uid=<?php echo $result['id'];?>">Изменить Email</a>
                                            </td>
                                        </tr>
                                        <tr>
